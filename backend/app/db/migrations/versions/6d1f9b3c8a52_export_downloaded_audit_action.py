"""export downloaded audit action

Revision ID: 6d1f9b3c8a52
Revises: 9a3d7c1e5f28
...
revision: str = '6d1f9b3c8a52'
down_revision: str | None = '9a3d7c1e5f28'
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_OLD_VALUES = ('USER_CREATED', 'USER_ROLE_CHANGED', 'USER_PASSWORD_RESET', 'USER_DELETED', 'EXPORT_CREATED')
_NEW_VALUES = (
...
def upgrade() -> None:
    ...
    if bind.dialect.name == 'postgresql':
        ...
        op.execute("ALTER TYPE auditaction ADD VALUE IF NOT EXISTS 'EXPORT_DOWNLOADED'")
    else:
