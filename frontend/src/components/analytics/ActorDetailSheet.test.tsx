  ...
  categories: [
    {
      ...
      total_bytes: 6000,
      domains: [
        { domain: 'cnn.com', category: 'news', request_count: 150, blocked_count: 0, total_bytes: 4000 },
        { domain: 'bbc.com', category: 'news', request_count: 50, blocked_count: 2, total_bytes: 2000 },
      ],
    },
    {
      ...
      total_bytes: 3000,
      domains: [
        { domain: 'x.com', category: 'social_media', request_count: 100, blocked_count: 0, total_bytes: 3000 },
      ],
    },
  ],
}
