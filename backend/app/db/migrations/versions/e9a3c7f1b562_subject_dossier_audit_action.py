"""subject dossier exported audit action

Revision ID: e9a3c7f1b562
Revises: b4f2e8a17c93
...
revision: str = "e9a3c7f1b562"
down_revision: str | None = "b4f2e8a17c93"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_NEW_VALUE = "SUBJECT_DOSSIER_EXPORTED"
_OLD = (
    ...
    "TOTP_DISABLED", "TOTP_RECOVERY_CODE_USED", "TELEGRAM_LINKED", "CLIENT_ACTIVITY_VIEWED",
    "EVENT_SEARCH_RUN", "ANALYTICS_ACTOR_VIEWED",
)
