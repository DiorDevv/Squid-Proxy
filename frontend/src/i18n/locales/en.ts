...
export const en = {
  ...
  'analytics.branches.riskDisclaimer':
    'A heuristic for ordering branches by where to look first — an uncalibrated blend of five signals, not a measured or validated risk value. Use the score to triage, not as a number to report.',
