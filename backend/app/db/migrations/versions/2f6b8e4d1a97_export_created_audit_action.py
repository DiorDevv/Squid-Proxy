"""export created audit action

Revision ID: 2f6b8e4d1a97
Revises: 8c4e2a71f9d3
...
revision: str = '2f6b8e4d1a97'
down_revision: str | None = '8c4e2a71f9d3'
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_OLD_VALUES = ('USER_CREATED', 'USER_ROLE_CHANGED', 'USER_PASSWORD_RESET', 'USER_DELETED')
_NEW_VALUES = ('USER_CREATED', 'USER_ROLE_CHANGED', 'USER_PASSWORD_RESET', 'USER_DELETED', 'EXPORT_CREATED')
...
def upgrade() -> None:
    ...
    if bind.dialect.name == 'postgresql':
        ...
        op.execute("ALTER TYPE auditaction ADD VALUE IF NOT EXISTS 'EXPORT_CREATED'")
    else:
