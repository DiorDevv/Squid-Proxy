...
export const en = {
  ...
  'clientDetail.timeSpentEstimateNote':
    'Estimated from gaps between requests to the same domain — a rough activity figure, not measured session time.',
  ...
  'analytics.who.searchPlaceholder': 'Find a user or client IP…',
  'analytics.who.searchAriaLabel': 'Search the leaderboard by user or client IP',
  'analytics.who.searchEmpty': 'No user or client IP matches your search in this range.',
  'analytics.who.colActor': 'Actor',
  'analytics.who.colUser': 'User',
  'analytics.who.colClientIp': 'Client IP',
  'analytics.who.downloadDossier': 'Dossier',
  ...
  'analytics.blocks.aclDenied': 'Forbidden (403)',
  'analytics.blocks.proxyAuth': 'Proxy auth (407)',
  'analytics.blocks.otherBlocked': 'Other denied',
  'analytics.blocks.reasonNote':
    'A 403 can come from the destination server (a geo-block, a WAF, an expired session), not only a proxy ACL — this view counts both. Only 407 is always the proxy.',
  ...
  'analytics.branches.signalsTitle': 'Branch signals',
  'analytics.branches.signalsHint': 'Raw per-branch signals — sort by whichever one matters to you',
  'analytics.branches.comparisonTitle': 'Allowed vs. blocked by branch',
  'analytics.branches.trendTitle': 'Traffic over time, by branch',
  'analytics.branches.trendHint': 'Allowed (green) and blocked (red), stacked',
  'analytics.branches.trendBranchEmpty': 'No traffic in this range.',
  'analytics.branches.categoryBreakdownTitle': 'What each branch is doing, by category',
  'analytics.branches.categoryBreakdownHint': 'Share of data transferred, per category',
  'analytics.branches.blockedDomainsTitle': 'Most blocked domains, by branch',
  ...
  'analytics.branches.colSensitivePct': 'Sensitive %',
  'analytics.branches.colAnomalies': 'Anomalies',
  'analytics.branches.colQuota': 'Quota breaches',
  'analytics.branches.colUncategorized': 'Uncateg. domains',
  ...
  'settings.nav.policy': 'Data policy',
  'settings.nav.systemHealth': 'System health',
  'sysHealth.backupTitle': 'Database backup',
  'sysHealth.backupNoData': 'No backup status available (JOB_STATUS_DIR not configured, or no backup has run yet).',
  'sysHealth.lastSuccess': 'Last successful',
  'sysHealth.lastResult': 'Last result',
  'sysHealth.ok': 'OK',
  'sysHealth.failed': 'Failed',
  'sysHealth.lastSize': 'Last dump size',
  'sysHealth.consecutiveFailures': 'Consecutive failures',
  'sysHealth.backupVolumeFree': 'Backup volume free',
  'sysHealth.error': 'Error',
  'sysHealth.offsiteTitle': 'Off-site replication',
  'sysHealth.offsiteNoData': 'No off-site status available.',
  'sysHealth.offsiteDisabled': 'Off-site replication is not configured.',
  'sysHealth.repo': 'Repository',
  'sysHealth.lastSync': 'Last sync',
  'sysHealth.lastCheck': 'Last check',
  'sysHealth.syncOk': 'Sync OK',
  'sysHealth.databaseTitle': 'Database & disk',
  'sysHealth.dbSize': 'Database size',
  'sysHealth.rawRows': 'raw_events rows',
  'sysHealth.rawAdded24h': 'Rows added (24h)',
  'sysHealth.rawWindow': 'raw_events window',
  'sysHealth.diskFree': 'Disk free',
  'sysHealth.diskUsed': 'Disk used',
  'sysHealth.ingestionTitle': 'Ingestion',
  'sysHealth.eventsDropping': 'The aggregator is falling behind — events are likely being dropped.',
  'sysHealth.lastEvent': 'Last event',
  'sysHealth.parseFailRate': 'Parse failures',
  'sysHealth.tailerAlive': 'tailer alive',
  'sysHealth.tailerDown': 'tailer DOWN',
  'sysHealth.unarchivedPurge': 'Purged without archiving: {{branches}}',
  'sysHealth.jobsTitle': 'Background jobs',
  'sysHealth.jobAlive': 'running',
  'sysHealth.jobStopped': 'STOPPED',
  'sysHealth.lastRun': 'Last run',
  'sysHealth.eventsTitle': 'Recent operational failures',
  'sysHealth.eventsEmpty': 'No operational failures recorded.',
  'settings.nav.categories': 'Categories & alerts',
  'settings.nav.export': 'Export',
  'settings.nav.retention': 'Retention',
  'retentionSettings.rawTitle': 'Per-request detail window',
  'retentionSettings.rawDaysLabel': 'Keep raw_events for (days)',
  'retentionSettings.rawDaysDescription': 'How long full per-request detail (client IP, URL, domain, bytes) stays queryable in the live database before the retention job purges it. Aggregated summaries for charts are kept far longer and are not affected. Weekly gzip archives (kept ARCHIVE_KEEP_DAYS) are also unaffected.',
  'retentionSettings.loweringWarning': 'Lowering this from {{from}} to {{to}} days will permanently delete rows older than {{to}} days on the next purge.',
  ...
  'retentionSettings.confirmProceed': 'Shorten and delete',
  ...
  'policy.purposeTitle': 'Purpose & controller',
  'policy.purpose': 'Processing purpose',
  'policy.controller': 'Data controller',
  'policy.notConfigured': 'Not configured',
  'policy.notConfiguredHint':
    'Set DATA_PROCESSING_PURPOSE and DATA_CONTROLLER in the backend configuration to state these.',
  'policy.retentionTitle': 'Retention windows',
  'policy.retentionRawEvents': 'Raw per-request events',
  'policy.retentionAggregates': 'Aggregated statistics',
  'policy.retentionOpsAggregates': 'Operational aggregates',
  'policy.retentionArchives': 'Encrypted archives on disk',
  'policy.retentionClientRollup': 'Per-client detail rolled up to hourly after',
  'policy.archivingTitle': 'Archiving before purge',
  'policy.archivingEnabled': 'Archiving enabled',
  'policy.archivingEncrypted': 'Archives encrypted at rest',
  'policy.archivingLocation': 'Archive location',
  'policy.collectedFieldsTitle': 'What is collected per request',
  'policy.days': '{{count}} day(s)',
  'policy.hours': '{{count}} hour(s)',
  ...
  'settings.exportManifestSigned': 'Signed manifest — download to verify offline with scripts/verify_export.py',
  'settings.exportManifestUnsigned':
    'Unsigned manifest (set EXPORT_SIGNING_PRIVATE_KEY to sign exports) — download for the checksum record',
  'settings.exportManifestDownloadFailed': 'Could not download the manifest.',
